...
From GURPS, we adopt a point-based character creation system and a flexible skill structure. Traits in \wyrd correspond loosely to GURPS advantages and disadvantages but are presented in a simplified, narrative-friendly format. We deliberately avoid the dense specialisation trees and extensive option lists that can overwhelm new players, but the system allows for it, as we explain in \fullchapref{chap:toolbox}, and we give a few examples in \fullchapref{chap:skill-list}.
