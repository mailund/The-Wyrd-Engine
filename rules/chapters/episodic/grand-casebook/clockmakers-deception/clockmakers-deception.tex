\begin{WyrdScenarioHeading}[The Clockmaker's Deception]{The Clockmaker's\\ Deception}
    ...
    \index{Scenario!The Clockmaker's Deception}
...
Thorne is defensive, paranoid, and deeply shaken. He’s also terrified of what will happen if his work falls into the wrong hands. A successful \textbf{Empathy} \DL{+1} check may reassure him enough to reveal more about his experimental designs or recent interactions with Bellamy.
