...
\begin{NPC}[%
    ...
    Erased in the failed rite, the monks persist as ambient sorrow. During exploration, they are non-hostile and may be seen performing fragments of their old routines. They cannot speak, but may respond to a player via visions if the players succeed with an \textbf{Empathy} roll at \DL{+2}.
...
\end{NPC}
\WyrdFooterImage{img/pageart/gothic_mountains_cleaned}
\end{multicols}
...
\end{CommentBox}
\end{paracol}
\WyrdFooterImage{img/pageart/abbot}
...
\begin{WyrdCharacterSheet}
    ...
    \begin{WyrdStatsBlock}[profile=img/characters/nina_maddox]
        ...
        \begin{GearBox}
            \item[Mysterious Letter] — A letter in her father’s handwriting, written in a shaky hand. It speaks of “the silence” and “the bell.” It is the only clue Nina has.
        \end{GearBox}
