...
\usepackage{hyperref}  % Allows reliable referencing of page numbers
\usepackage{refcount}  % Provides \getpagerefnumber to fetch page numbers

% Define a command for referencing the page of a label
