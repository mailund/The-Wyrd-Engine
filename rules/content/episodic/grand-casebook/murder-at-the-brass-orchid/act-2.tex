...
\input{content/episodic/grand-casebook/murder-at-the-brass-orchid/npcs/staff.tex}
\input{content/episodic/grand-casebook/murder-at-the-brass-orchid/npcs/patrons.tex}
...
\begin{WyrdComment}{Clues to Discover}
	\begin{itemize}
		...
		\item \textbf{A Torn Letter:} A small stove used to heat the performers' dressing room contains scraps of partially burned paper—its edges matching the torn note found in Mercer’s hand. If pieced together, it may hint at the nature of their final confrontation.
...
Any investigator willing to \textbf{crawl inside} will find it claustrophobic, the \textbf{walls cool and slick} from years of condensation. The air carries a \textbf{faint metallic tang}, mingled with the stale scent of old receipts and spilt brandy. A few \textbf{scraps of paper} cling to the corners of the passage, suggesting messages were hurriedly sent or torn up mid-transit. If they push forward, they may notice \textbf{a single dark thread caught on a rivet}—a clue that someone in dark clothing passed through recently.  
