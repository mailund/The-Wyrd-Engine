...
\wyrd uses \textbf{Stress}\index{Damage!Stress}\index{Stress} to represent minor injuries and \textbf{Wounds}\index{Damage!Wounds}\index{Wounds} for more serious, lasting harm. %% TODO: FROM HERE
...
\begin{DndReadAloud}{Damage soaking capability of a player character:}
    \\\noindent
	\FramedDamageBox
\end{DndReadAloud}
...
\begin{DndSidebar}[float=!t]{Example Character}
	\subsection{Captain Elias Mercer}
...
\end{DndSidebar}
\begin{DndReadAloud}{}
\subsubsection{Example: Stress Damage}
...
\begin{DndReadAloud}{}
\subsubsection{Example: Wound Damage}
